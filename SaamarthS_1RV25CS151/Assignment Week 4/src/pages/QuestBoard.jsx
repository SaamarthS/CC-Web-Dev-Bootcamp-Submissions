...
export default function QuestBoard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-4xl font-serif font-bold text-[#3B1F2B] mb-2 text-center">My Quests ⚔️</h1>
      <p className="text-center text-slate-500 mb-8 font-medium">What adventures await you today?</p>
      ...
      {quests.length === 0 ? (
        <div className="text-center py-16 bg-white/50 backdrop-blur rounded-2xl border border-pink-50 shadow-sm">
